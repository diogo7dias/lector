...
constexpr uint32_t HEADER_SIZE = sizeof(uint8_t) + sizeof(int) + sizeof(float) + sizeof(bool) + sizeof(uint8_t) +
                                 ...
                                 sizeof(uint8_t) + sizeof(bool) + sizeof(int) + sizeof(uint32_t) + sizeof(uint32_t) +
...
void Section::writeSectionFileHeader(const int fontId, const float lineCompression, const bool extraParagraphSpacing,
                                     ...
                                     const bool focusReadingEnabled, const int firstLineIndentPx) {
  if (!file) {
  ...
  static_assert(HEADER_SIZE == sizeof(SECTION_FILE_VERSION) + sizeof(fontId) + sizeof(lineCompression) +
                                   ...
                                   sizeof(firstLineIndentPx) + sizeof(uint32_t) + sizeof(uint32_t) + sizeof(uint32_t) +
                                   sizeof(uint32_t),
...
bool Section::loadSectionFile(const int fontId, const float lineCompression, const bool extraParagraphSpacing,
  ...
  // Match parameters
  {
    ...
    if (fontId != fileFontId || lineCompression != fileLineCompression ||
        ...
        firstLineIndentPx != fileFirstLineIndentPx) {
      file.close();
...
bool Section::createSectionFile(const int fontId, const float lineCompression, const bool extraParagraphSpacing,
                                ...
                                const uint16_t viewportHeight, const bool hyphenationEnabled, const bool embeddedStyle,
                                const uint8_t imageRendering, const bool focusReadingEnabled,
                                const int firstLineIndentPx, const std::function<void()>& popupFn) {
  ...
  ChapterHtmlSlimParser visitor(
      ...
      viewportHeight, hyphenationEnabled, focusReadingEnabled, firstLineIndentPx,
