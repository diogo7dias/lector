...
class GfxRenderer {
 ...
 public:
  ...
  void ensureSdCardFontReady(int fontId, const std::deque<std::string>& words, uint8_t styleMask = 0x0F) const;
  ...
  // Fast path for unscaled glyphs: same result as drawPixel() per ink pixel, clipped and rotated once per glyph.
