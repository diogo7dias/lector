...
class SdCardFont {
 public:
  ...
  int buildAdvanceTable(const std::deque<std::string>& words, uint8_t styleMask = 0x0F,
 ...
 private:
  ...
  int buildAdvanceTableRange(Iter begin, Iter end, bool includeSpace, uint8_t styleMask,
                             const char* extraText = nullptr);
