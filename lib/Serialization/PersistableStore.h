...
class PersistableStoreBase {
 protected:
  ...
  // CrossPointSettings::readerRenderSpec) unlocked. If you ever lock this mutex on
 ...
 public:
  ...
  // Skips identical serialized values; otherwise stages and swaps (ensures /.crosspoint exists). Logs on failure.
