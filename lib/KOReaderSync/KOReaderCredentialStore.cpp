...
// A username or URL typed on the on-screen keyboard picks up stray spaces, and
// they travel into the x-auth-user header or the request URL, where they read as
// wrong credentials or a bad host with nothing on screen to explain it. The
// password is never trimmed: a space in a password is part of the password.
