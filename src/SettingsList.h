...
inline std::vector<SettingInfo> getSettingsList(const SdCardFontRegistry* registry = nullptr,
  ...
  static const std::vector<SettingInfo> baseList = [] {
    ...
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_SLEEP_IMAGE_QUALITY, &CrossPointSettings::sleepImageQuality,
                          {StrId::STR_SLEEP_QUALITY_FAST, StrId::STR_SLEEP_QUALITY_PRETTY}, "sleepImageQuality",
                          StrId::STR_CAT_DISPLAY),
        SettingInfo::Toggle(StrId::STR_WAKE_STRAIGHT_TO_BOOK, &CrossPointSettings::wakeStraightToBook,
        ...
        SettingInfo::Value(StrId::STR_SCREEN_MARGIN, &CrossPointSettings::screenMargin,
            ...
            .withTextSettings(),
        SettingInfo::Value(StrId::STR_SCREEN_MARGIN_TOP, &CrossPointSettings::screenMarginTop,
                           {CrossPointSettings::SCREEN_MARGIN_MIN, CrossPointSettings::SCREEN_MARGIN_MAX, 5},
                           "screenMarginTop", StrId::STR_CAT_READER)
            .withTextSettings(),
        SettingInfo::Value(StrId::STR_SCREEN_MARGIN_BOTTOM, &CrossPointSettings::screenMarginBottom,
                           {CrossPointSettings::SCREEN_MARGIN_MIN, CrossPointSettings::SCREEN_MARGIN_MAX, 5},
        ...
        SettingInfo::Toggle(StrId::STR_FOCUS_READING, &CrossPointSettings::focusReadingEnabled, "focusReadingEnabled",
                            StrId::STR_CAT_READER)
            .withTextSettings(),
        SettingInfo::Toggle(StrId::STR_GUIDE_DOTS, &CrossPointSettings::guideDotsEnabled, "guideDotsEnabled",
                            StrId::STR_CAT_READER)
            .withTextSettings(),
        ...
        SettingInfo::Toggle(StrId::STR_MOVE_OPENED_TO_RECENTS, &CrossPointSettings::moveOpenedToRecentsFolder,
        ...
        SettingInfo::Toggle(StrId::STR_STATUS_BAR, &CrossPointSettings::sbEnabled, "sbEnabled",
        ...
        SettingInfo::Enum(StrId::STR_TITLE_SOURCE, &CrossPointSettings::sbTitleSource,
                          {StrId::STR_BOOK, StrId::STR_CHAPTER}, "sbTitleSource", StrId::STR_CUSTOMISE_STATUS_BAR),
        SettingInfo::Toggle(StrId::STR_TRUNCATE_TITLE, &CrossPointSettings::sbTitleTruncate, "sbTitleTruncate",
                            StrId::STR_CUSTOMISE_STATUS_BAR),
        SettingInfo::Enum(StrId::STR_PAGE_IN_CHAPTER, &CrossPointSettings::sbPagePos,
                          {StrId::STR_STATE_OFF, StrId::STR_ANCHOR_TL, StrId::STR_ANCHOR_TC, StrId::STR_ANCHOR_TR,
                           StrId::STR_ANCHOR_BL, StrId::STR_ANCHOR_BC, StrId::STR_ANCHOR_BR},
                          "sbPagePos", StrId::STR_CUSTOMISE_STATUS_BAR),
        SettingInfo::Enum(StrId::STR_PAGE_FORMAT, &CrossPointSettings::sbPageFormat,
        ...
        SettingInfo::Enum(StrId::STR_BOOK_BAR, &CrossPointSettings::sbBookBar,
                          {StrId::STR_STATE_OFF, StrId::STR_TOP, StrId::STR_BOTTOM}, "sbBookBar",
                          StrId::STR_CUSTOMISE_STATUS_BAR),
        SettingInfo::Enum(StrId::STR_CHAPTER_BAR, &CrossPointSettings::sbChapterBar,
        ...
        SettingInfo::Enum(StrId::STR_BAR_THICKNESS, &CrossPointSettings::sbBarThickness,
                          ...
                          StrId::STR_CUSTOMISE_STATUS_BAR),
        SettingInfo::Toggle(StrId::STR_FLOATING_BAR, &CrossPointSettings::sbFloatingBar, "sbFloatingBar",
                            StrId::STR_CUSTOMISE_STATUS_BAR),
        SettingInfo::Toggle(StrId::STR_BAR_OUTLINE, &CrossPointSettings::sbBarOutline, "sbBarOutline",
                            StrId::STR_CUSTOMISE_STATUS_BAR),
