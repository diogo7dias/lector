...
A personal fork of [CrossPoint Reader](https://github.com/crosspoint-reader/crosspoint-reader) for the Xteink X3 and X4.

It follows CrossPoint closely. Upstream fixes are pulled in regularly, and everything below is a small personal change on top. The original CrossPoint README follows this section, unchanged.
