...
# Overridable so a one-off kit can carry a different build (e.g. env:stock_refresh
# for the X3 ghosting baseline) without editing this script.
ENV_NAME="${TESTKIT_ENV:-testkit}"
