...
Status: PLAN ONLY, nothing implemented. Baseline: v0.9.1 (`4baf6cf`).
...
All file references verified against the working tree. Every phase ends with a device-verifiable check.
